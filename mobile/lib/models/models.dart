...
class InventoryItem {
  ...
  factory InventoryItem.fromJson(Map<String, dynamic> j) =>
      InventoryItem(j['type'] as int, j['name'] as String, j['icon'] as String, j['stars'] as int, j['amount'] as int);
}
...
class Battle {
  ...
  final String region, attacker, attackerFlag, defender, defenderFlag, type;
...
class GameEvent {
  GameEvent.fromJson(Map<String, dynamic> j)
      : title = j['title'] as String,
