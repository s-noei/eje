...
JSFX.Firework = function(fwImages)
{
	...
	this.superC = JSFX.fxLayer;
	this.superC("<img src='"+fwImages[0].src+"' name='"+this.imgId+"' alt='PARTY' title='eJahan v1.5 is released!'>");
...
JSFX.FireworkDisplay.prototype.loadImages = function(fwName, numImages)
{
	for(var i=0 ; i<numImages ; i++)
	{
		...
		this.imgArray[i].src = "images/firework/"+fwName+"/"+i+".gif";
	}
}
...
myFW1 = new JSFX.FireworkDisplay(5, "fw08", 26);
//myFW2 = new JSFX.FireworkDisplay(5, "fw03", 21);
myFW2 = new JSFX.FireworkDisplay(5, "fw01", 28);
myFW3 = new JSFX.FireworkDisplay(5, "fw01", 28);
myFW4 = new JSFX.FireworkDisplay(5, "fw01", 21);
